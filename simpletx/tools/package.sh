...
"$DOTNET" build "$PLUGIN_DIR/src/Zeus.Plugin.Simpletx/Zeus.Plugin.Simpletx.csproj" -c Release >/dev/null

BUILD="$PLUGIN_DIR/src/Zeus.Plugin.Simpletx/bin/Release/net10.0"
